...
const INITIAL_TASKS: Task[] = [
  { id: 1, title: "Оформить титульный лист", description: "Тема: «Экосистемы и круговорот веществ», дисциплина: биология, руководитель: Полторацкая Л.А.", status: "done", priority: "high", assignee: "Иванов И.И.", dueDate: "2026-03-10", section: "Оформление" },
  { id: 2, title: "Написать ВВЕДЕНИЕ", description: "Актуальность темы, цель и задачи, объект — экосистемы, предмет — круговорот веществ, методы исследования", status: "done", priority: "high", assignee: "Иванов И.И.", dueDate: "2026-03-12", section: "Основная часть" },
  { id: 3, title: "1.1 Понятие экосистемы", description: "Определения по разным источникам, история термина, ключевые понятия: биоценоз, биотоп, продуценты, консументы, редуценты", status: "in_progress", priority: "high", assignee: "Иванов И.И.", dueDate: "2026-03-16", section: "Основная часть" },
  { id: 4, title: "1.2 Структура и компоненты экосистем", description: "Биотические и абиотические компоненты. Примеры экосистем: лес, луг, водоём, агроэкосистема", status: "in_progress", priority: "high", assignee: "Иванов И.И.", dueDate: "2026-03-18", section: "Основная часть" },
  { id: 5, title: "1.3 Понятие и виды круговорота веществ", description: "Малый и большой круговорот. Круговорот углерода, азота, воды, фосфора. Схемы и диаграммы", status: "todo", priority: "high", assignee: "Иванов И.И.", dueDate: "2026-03-21", section: "Основная часть" },
  { id: 6, title: "1.4 Роль живых организмов в круговороте", description: "Трофические цепи и сети. Роль продуцентов, консументов, редуцентов в круговороте веществ", status: "todo", priority: "medium", assignee: "Иванов И.И.", dueDate: "2026-03-24", section: "Основная часть" },
  { id: 7, title: "Глава 2 — Практическая часть", description: "Анкетирование: осведомлённость студентов об экосистемах. Графики и выводы по результатам", status: "todo", priority: "medium", assignee: "Иванов И.И.", dueDate: "2026-03-28", section: "Основная часть" },
  { id: 8, title: "Написать ЗАКЛЮЧЕНИЕ", description: "Выводы по каждой главе. Достигнута ли цель? Подтверждена ли гипотеза? Перспективы изучения темы", status: "todo", priority: "medium", assignee: "Иванов И.И.", dueDate: "2026-04-02", section: "Основная часть" },
  { id: 9, title: "Оформить список источников", description: "ГОСТ-оформление. Не менее 5 источников по теме экологии и биологии. Ссылки в тексте [1, с. 45]", status: "todo", priority: "high", assignee: "Иванов И.И.", dueDate: "2026-04-04", section: "Оформление" },
  { id: 10, title: "Приложения: схемы круговоротов", description: "Схемы круговорота углерода, азота, воды. Каждое приложение с новой страницы, до 10 стр.", status: "todo", priority: "low", assignee: "Иванов И.И.", dueDate: "2026-04-06", section: "Оформление" },
  { id: 11, title: "Проверка уникальности", description: "Антиплагиат — минимум 70%. При цитировании учебников и статей обязательны ссылки", status: "todo", priority: "high", assignee: "Иванов И.И.", dueDate: "2026-04-09", section: "Проверка" },
  { id: 12, title: "Финальное форматирование", description: "TNR 14pt, интервал 1,5, поля: верх/низ 2 см, лево 3 см, право 1,5 см. Нумерация со 2-й страницы", status: "todo", priority: "high", assignee: "Иванов И.И.", dueDate: "2026-04-11", section: "Оформление" },
];
...
const SOURCE_EXAMPLES: Source[] = [
  { id: 1, type: "book1",        text: "Реймерс, Н. Ф. Экология (теории, законы, правила, принципы и гипотезы) [Текст] / Н. Ф. Реймерс. – М. : Россия молодая, 1994. – 367 с." },
  { id: 2, type: "book2",        text: "Одум, Ю. Основы экологии [Текст] : учеб. пособие / Ю. Одум, Г. Одум; под ред. Н. П. Наумова. – М. : Мир, 1986. – 740 с." },
  { id: 3, type: "encyclopedia", text: "Экологический энциклопедический словарь [Текст] / под ред. В. В. Снакина. – М. : НИА-Природа, 2002. – 624 с." },
  { id: 4, type: "article",      text: "Миркин, Б. М. Экосистема: структура, устойчивость, управление [Текст] / Б. М. Миркин // Биология в школе. – 2018. – № 4. – С. 12–19." },
  { id: 5, type: "web",          text: "Круговорот веществ в природе [Электронный ресурс] // Национальная образовательная инициатива «Наша новая школа». – Режим доступа: https://bio.1sept.ru. – 10.02.2026." },
];
...
const INITIAL_TOC: TocEntry[] = [
  ...
  { id: "1-1",     level: "sub",     label: "1.1 Понятие экосистемы",                          page: 4 },
  { id: "1-2",     level: "sub",     label: "1.2 Структура и компоненты экосистем",            page: 5 },
  { id: "1-3",     level: "sub",     label: "1.3 Понятие и виды круговорота веществ",          page: 7 },
  { id: "1-4",     level: "sub",     label: "1.4 Роль живых организмов в круговороте веществ", page: 9 },
  { id: "ch2",     level: "chapter", label: "ГЛАВА 2 ПРАКТИЧЕСКАЯ ЧАСТЬ",                     page: 12 },
  { id: "2-1",     level: "sub",     label: "2.1 Анкетирование",                               page: 12 },
  { id: "2-2",     level: "sub",     label: "2.2 Графики и выводы",                            page: 14 },
  { id: "outro",   level: "heading", label: "ЗАКЛЮЧЕНИЕ",                                      page: 18 },
  { id: "sources", level: "heading", label: "СПИСОК ИСПОЛЬЗОВАННЫХ ИСТОЧНИКОВ",                page: 19 },
  { id: "append",  level: "appendix",label: "ПРИЛОЖЕНИЯ",                                      page: 20 },
];
...
export default function Index() {
  ...
  const [titleData, setTitleData] = useState({
    ...
    topic: "«Экосистемы и круговорот веществ»",
    discipline: "биологии",
